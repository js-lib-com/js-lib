...
js.dom.Image.prototype = {_TRANSPARENT_DOT: 'data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==', setSrc: function(src) {
  if (!src || /^\s+|(?:&nbsp;)+$/g.test(src)) 
  {
    return this.reset();
  }
...
js.dom.ImageControl.prototype = {reset: function() {
  if (this._defaultSrc != null) 
  {
    this._node.src = this._defaultSrc;
  } else {
...
js.dom.template.ConditionalExpression.State = {NONE: 0, STATEMENT: 1, PROPERTY_PATH: 2, OPERAND: 3};
...
js.format.BitRate.Unit = {1: "bit/s", 1000: "Kbit/s", 1000000: "Mbit/s", 1000000000: "Gbit/s", 1000000000000: "Tbit/s"};
...
js.format.Duration.Unit = {1: "msec.", 1000: "sec.", 60000: "min.", 3600000: "hr.", 86400000: "days", 2592000: "months", 946080000000: "years"};
js.format.Duration.prototype = {_VALID_INPUT: function() {
  var units = [];
